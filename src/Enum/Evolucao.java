...
public enum Evolucao {
    ...
    CHARMILION("Charmeleon", CHARMANDER),
    CHARIZARD("Charizard", CHARMILION),

    BULBASAURO("Bulbasauro", null), // Não tem evolução anterior
    IVYSAURO("Ivysauro", BULBASAURO),
    VENOSAURO("Venosauro", IVYSAURO);
    ...
    public Evolucao getEvolucaoAnterior() {return evolucaoAnterior;}
}
