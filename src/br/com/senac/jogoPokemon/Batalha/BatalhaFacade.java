package br.com.senac.jogoPokemon.Batalha;
...
public class BatalhaFacade {
	...
	public void start(Pokemon pokemon1, Pokemon pokemon2) {
        ...
        // Factory: implementa a logica de evolucao do pokemon, ela foi encapsulada em uma classe propria para isso, a classe principal 
        // apenas passa os parametros para a classe EvolucaoFactory executar e retornar a proxima evolucao do pokemon
        pokemon1.evoluir();
